  ...
  return (
    <section className="space-y-8">
      ...
      <div className="grid gap-6 lg:grid-cols-[2fr,1fr]">
        <div className="space-y-4 rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
          ...
          <p className="text-xs text-slate-400">
            Hinweis: Name und Geburtsdatum können nur vom Administrator geändert werden. Deine E-Mail ist dein
            Benutzername für Timesheet und Kalender.
          </p>
      ...
      <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <form action={pinFormAction} className="mt-4 space-y-4" autoComplete="off">
          <div className="grid gap-4 sm:grid-cols-2">
            <label className="flex flex-col gap-1 text-sm text-slate-700">
      ...
      <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <form action={passwordFormAction} className="mt-4 space-y-4" autoComplete="off">
          <div className="grid gap-4 sm:grid-cols-2">
            <label className="flex flex-col gap-1 text-sm text-slate-700">
